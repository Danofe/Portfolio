...
//className="h-screen flex justify-center relative items-center snap-center perspective-600"
  ...
  <section style={{background: color }} className={`h-screen flex justify-center relative items-center snap-center perspective-1200`} >
    ...
    <motion.h2 className=' m-0 left-[calc(50%+130px)] absolute top-[28%] text-Bcolor font-bold text-6xl tracking-tighter leading-5  'initial={{opacity: 0}} style={{y}} animate={{opacity: hover ? 100 : 0, x: hover ? 0 : 200}}>{`${id}`}</motion.h2>
    <motion.div style={{y}} animate={{opacity: hover ? 50 : 0, width: hover ? 450 : 0}} transition={{duration: hover ? 1 : 0, delay: hover ? 0.3 : 0}} className='rounded left-[calc(50%+130px)] h-1 absolute top-[37%] bg-blue-400'></motion.div>
    ...
    <motion.div style={{y}} animate={{opacity: hover ? 50 : 0, width: hover ? 450 : 0}} transition={{duration: hover ? 1 : 0, delay: hover ? 0.3 : 0}} className='rounded left-[calc(50%+130px)] h-1 absolute top-[75%] bg-blue-400'></motion.div>
