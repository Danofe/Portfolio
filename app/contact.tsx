...
function Contact() {
  return (
    <div className='w-screen h-screen mt-4 flex items-center justify-center snap-center'>
      <div className='w-1/2 flex-row justify-center bg-Tcolor/20 shadow-lg border-4 border-Tcolor/20 rounded'>
          
            <h1 className=' text-center font-bold text-Bcolor text-6xl tracking-tighter pt-5 justify-center h-24'>Contact Me</h1>


          <div className='border-y-4 p-5 border-Tcolor/20'>
        ...
        <div className='border-b-4 p-5 border-Tcolor/20'>
        ...
        <div className='p-5 border-Tcolor/20'>
